...
jet_key = 'scrlk'
# canonical names: https://github.com/boppreh/keyboard/blob/master/keyboard/_canonical_names.py#L11
# avoid letter keys which interfere with typing in the chat box
...
print("Joystick/gamepad detected. Running...")
